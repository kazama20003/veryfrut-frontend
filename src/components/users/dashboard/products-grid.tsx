...
export function UsersDashboard() {
  ...
  return (
    <>
      <div className="flex min-h-screen flex-col bg-gray-50 rounded-lg overflow-hidden">
        {/* Header */}
        <header className="sticky top-0 z-40 border-b bg-white shadow-sm rounded-t-lg">
